...
- **Check:** `npx deuk-agent-rule lint:md core-rules/AGENTS.md .deuk-agent/tickets/sub/255-low-capability-agent-rule-redesi-joy-nucb.md .deuk-agent/docs/plan/255-deukpack-project-guardrail-rollout.md`
