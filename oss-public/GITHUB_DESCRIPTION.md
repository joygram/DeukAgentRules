...
```
DeukAgentRules — Cursor, Copilot, Gemini, Claude, Windsurf, JetBrains AI Assistant 등 코딩 에이전트용 AGENTS.md·.cursor 룰 템플릿. 핸드오프·간결 응답으로 비용·성능을 개선합니다. npx deuk-agent-rule init은 태그 구역만 갱신하고 나머지 룰은 유지합니다.
```
